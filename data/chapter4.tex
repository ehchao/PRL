...
Comme le nombre de points-$\vb{k}$ n'est pas élevé,
...
%TODO:Redraw kpt_compare if we have time, too small the captions and legends
\begin{figure}[!h]
    \centering
...
%TODO: redraw this figure, bad legend
\begin{figure}[!h]
    \centering
