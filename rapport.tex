...
À nouveau, le terme d'échange et de corrélation $f_{xc}$ doit être approximé. Les méthodes d'approximation que nous utilisons dans le cadre de ce projet est la \textit{Random Phase Approximation} (RPA) et la \textit{Adiabatic Local Density Approximation} (ALDA).
...
%TODO une présentation d'Abinit (done) et de DP
